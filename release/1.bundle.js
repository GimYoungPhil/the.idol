...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [
	...
	], __WEBPACK_AMD_DEFINE_RESULT__ = function(IdolManager) {
	  ...
	  IdolManager.module('IdolApp', function(IdolApp, IdolManager, Backbone, Marionette, $, _) {
	    ...
	    var API = {
	      listIdol: function() {
	        __webpack_require__.e/* require */(2, function(__webpack_require__) { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(12)]; (function(ListController) {
	          ListController.listIdol();
	          IdolManager.execute('set:active:header', 'idols');
	        }.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));});
	      },
	      newIdol: function() {
	        __webpack_require__.e/* require */(3, function(__webpack_require__) { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(15)]; (function(NewController) {
	          NewController.newIdol();
	          IdolManager.execute('set:active:header', 'idols');
	        }.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));});
	      },
	      showIdol: function(id) {
	        __webpack_require__.e/* require */(4, function(__webpack_require__) { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(16)]; (function(ShowController) {
	          ShowController.showIdol(id);
	          IdolManager.execute('set:active:header', 'idols');
	        }.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));});
	      },
	      editIdol: function(id) {
	        __webpack_require__.e/* require */(5, function(__webpack_require__) { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(17)]; (function(EditController) {
